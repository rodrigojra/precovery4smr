 ...
 * @author Joao Sousa
 */
public class GraphApplicationState implements ApplicationState {
    ...
    public COS getMessageGraphBatch(int cid) {
    	return null;
    }
    
    public MutableGraph<Command> getMessageMutableGraphBatch(int cid) {
    	return null;
    }
    
    public List<Command> getMessageListBatch(int cid) {
    	return null;
    }    
     ...
     */
    public GraphApplicationState(CommandsInfo[] messageBatches, int lastCheckpointCID, int lastCID, byte[] state, byte[] stateHash, int pid) {
    ...
    public GraphApplicationState(CommandsInfo[] messageBatches, byte[] logHash, int lastCheckpointCID, int lastCID, byte[] state, byte[] stateHash, int pid) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof GraphApplicationState) {
            GraphApplicationState tState = (GraphApplicationState) obj;
