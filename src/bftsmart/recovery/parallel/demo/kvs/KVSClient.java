...
public class KVSClient<K, V> implements Map<K, V>{
	
	ServiceProxy serviceProxy;
	
	public KVSClient(int clientId) {
	...
	public V put(K key, V value) {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
			...
			objOut.writeObject(KVSRequestType.PUT);
	...
	public V get(Object key) {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
			...
			objOut.writeObject(KVSRequestType.GET);
			objOut.writeObject(key);
	...
	public V remove(Object key) {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
			...
			objOut.writeObject(KVSRequestType.REMOVE);
			objOut.writeObject(key);
	...
	public int size() {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
				ObjectOutput objOut = new ObjectOutputStream(byteOut);) {
			objOut.writeObject(KVSRequestType.SIZE);
			objOut.flush();
			byteOut.flush();
	...
	public Set<K> keySet() {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
			...
			objOut.writeObject(KVSRequestType.KEYSET);
