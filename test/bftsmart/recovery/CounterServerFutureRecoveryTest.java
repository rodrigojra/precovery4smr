...
public class CounterServerFutureRecoveryTest {
	...
	@Test
	public final void testSetStateFutureNoDep() throws NoSuchAlgorithmException {
		CounterServerFuture countServerRecovery = new CounterServerFuture();
